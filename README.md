Hello Bonnie, could you check please my testUtils setup file (router)? It's a bit different project from that we have on the course, but all test utils logic is the same. 
